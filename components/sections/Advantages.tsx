...
import { Link2, Repeat, Target, TrendingUp, Users, Globe, BarChart3, Network } from 'lucide-react';
...
export default function Advantages({ track }: AdvantagesProps) {
  const trackKey = track === 'tactical-medicine' ? 'tactical_medicine' : 'uav';
  const t = useTranslations(`advantages.${trackKey}`);
